...
$render = '	<div id="shirt-container" style="position: relative;
width: 100%;
height: 85vh;
overflow: hidden;
">
				<div class="base"><input type="hidden" name="img_file_face" value="' . $render_face_jpg . '" id="img_file_face" /><img id="view_face" src="' . $render_face_jpg . '?t = ' . $t . '" style="width:100%;
position:absolute;
top:0;
left:0;
display:block;
"></div>
				<div class="base"><input type="hidden" name="img_file_dos" value="' . $render_dos_jpg . '" id="img_file_dos" /><img id="view_dos" src="' . $render_dos_jpg . '?t = ' . $t . '" style="width:100%;
position:absolute;
top:0;
left:0;
display:none;
"></div>
				<div class="base"><input type="hidden" name="img_file_zoom" value="' . $render_zoom_jpg . '" id="img_file_zoom" /><img id="view_zoom" src="' . $render_zoom_jpg . '?t = ' . $t . '" style="width:100%;
position:absolute;
top:0;
left:0;
display:none;
