...
document.addEventListener("click", function(t) {
    for (var e = t.target || t.srcElement, n = Array.from(document.querySelectorAll(".selected-item")), s = Array.from(document.querySelectorAll(".select-custom ul")), o = 0; o < n.length; o++)
        n[o].contains(e) || (s[o].className = "")
}, !1);
for (var selectCustom = Array.from(document.querySelectorAll(".select-custom")), i = 0; i < selectCustom.length; i++)
    !function(t) {
        for (var e = selectCustom[t].querySelector(".value"), n = selectCustom[t].parentElement.querySelector("select"), s = selectCustom[t].querySelector("ul"), o = "", r = 0; r < n.options.length; r++)
            o += '<li data-id="' + r + '">' + n.options[r].text + "</li>";
        s.innerHTML = o;
        for (var i = Array.from(selectCustom[t].querySelectorAll("li")), a = 0; a < i.length; a++)
            i[a].addEventListener("click", function(t) {
                t.preventDefault();
                for (var s = 0; s < n.options.length; s++)
                    s == this.dataset.id ? n.options[s].selected = !0 : n.options[s].selected = !1;
...
["bas-hover.png", "boutons-hover.png", "broderies-hover.png", "cols-hover.png", "dos-hover.png", "doublures-hover.png", "poches-hover.png", "poignets-hover.png", "tissus-hover.png"].forEach(function(t) {
    ...
    Array.from(document.querySelectorAll(".step")).forEach(function(t) {
...
}), Array.from(document.querySelectorAll("#configurator nav li, #step-0 .part")).forEach(function(t) {
    t.addEventListener("click", function(e) {
        dataId = parseInt(t.getAttribute("data-id")), document.querySelector("nav").classList.remove("hidden"), document.querySelector("button.back").classList.remove("hidden"), document.querySelector("#step-0").classList.add("hidden"), document.querySelector("#step-" + dataId).classList.remove("hidden"), Array.from(document.querySelectorAll("#configurator nav li")).forEach(function(t) {
            return t.classList.remove("active")
        }), document.querySelector(".item-" + dataId).classList.add("active"), Array.from(document.querySelectorAll(".step")).forEach(function(t) {
            return t.classList.add("hidden")
...
}), Array.from(document.querySelectorAll("#configurator .content .close")).forEach(function(t) {
    return t.addEventListener("click", function(t) {
        Array.from(document.querySelectorAll("#configurator .step")).forEach(function(t) {
            return t.classList.add("hidden")
...
f.append("couleur", "tous"), f.append("motif", "tous"), f.append("tissage", "tous"),
    ...
    if (sessionStorage.getItem(t)) {
        Array.from(document.querySelectorAll('.part[data-category="' + t + '"]')).forEach(function(t) {
            return t.classList.remove("active")
        });
