...
<html>
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class = "col-xs-12 col-md-6">
                    ...
                    <div class="description-container">
                        ...
                        <a class="modifier-chemise">Ou modifiez le style de cette chemise dans le configurateur</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">var t =<?php echo time(); ?>;
            document.querySelector(".modifier-chemise").addEventListener("click", function(e) {
                document.forms['toConfig'].submit();
            });
        </script>
