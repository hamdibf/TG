...
class TgSession {
    ...
    public static function getGreeting($bdd) {
        ...
        if ($data['client_id'] == 0) {
            ...
            $qq = $bdd->query($ss);
            $dd = $qq->fetch();
            echo 'Bonjour ' . ucfirst($dd['prenom']) . ' ' . ucfirst($dd['nom']) . ', accédez à <a class="oswald-regular" href="espace-client.html">votre compte</a><br><br><a class="oswald-regular" href="deconnexion.html">Se d&eacute;connecter</a>';
        }
    }
