                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-md-offset-2">
                                <div class="modif-mesure-chemise chemise-face">
                                    <div class="ajustement-container ajustement-col">
                                        ...
                                        <input type="text" class="ajustement-input" name="cou_chem" id="cou_chem" value="<?php if ($mesures['cou_chem'] == '' || $mesures['cou_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['cou_chem']; ?>">
                                    ...
                                    <div class="ajustement-container ajustement-poitrine">
                                        ...
                                        <input type="text" class="ajustement-input" name="poitrine_chem" id="poitrine_chem" value="<?php if ($mesures['poitrine_chem'] == '' || $mesures['poitrine_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['poitrine_chem']; ?>">
                                    ...
                                    <div class="ajustement-container ajustement-taille">
                                        ...
                                        <input type="text" class="ajustement-input" name="ceinture_chem" id="ceinture_chem" value="<?php if ($mesures['ceinture_chem'] == '' || $mesures['ceinture_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['ceinture_chem']; ?>">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="modif-mesure-chemise chemise-dos">
                                    <div class="ajustement-container ajustement-epaule">
                                        ...
                                        <input type="text" class="ajustement-input" name="epaule_chem" id="epaule_chem" value="<?php if ($mesures['epaule_chem'] == '' || $mesures['epaule_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['epaule_chem']; ?>">
                                    ...
                                    <div class="ajustement-container ajustement-bras">
                                        ...
                                        <input type="text" class="ajustement-input" name="bras_chem" id="bras_chem" value="<?php if ($mesures['bras_chem'] == '' || $mesures['bras_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['bras_chem']; ?>">
                                    ...
                                    <div class="ajustement-container ajustement-dos">
                                        ...
                                        <input type="text" class="ajustement-input" name="dos_chem" id="dos_chem" value="<?php if ($mesures['dos_chem'] == '' || $mesures['dos_chem'] == 'NON-DEFINI') echo '74';
        else echo $mesures['dos_chem']; ?>">
