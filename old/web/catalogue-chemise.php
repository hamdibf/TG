<?php 
	...
	$description = "";
	$sql = 'select count(*) as n from tailorgeorge_modele';
	$query = $bdd->query($sql);
	$data = $query->fetch();
	$count = $data['n'];
	$categorie = '';
	if($alias!='')
	{
		...
		$ss = 'select count(*) as n from tailorgeorge_modele where categorie="'.$designation.'"';
		$qq = $bdd->query($ss);
		$dd = $qq->fetch();
		$count = $dd['n'];
	}
                ...
                <div class="filtres-catalogue-container">
                    ...
                    <ul class="filtres-catalogue oswald-regular" id="filtres-catalogue">
                        <li id="filtre_couleur_select">
                           <span id="filtre_couleur_selected"><?php if($categorie=='COULEUR') echo ucfirst($designation); else echo 'Couleurs'; ?></span>
                        ...
                        <li id="filtre_cols_select">
                           <span id="filtre_cols_selected"><?php if($categorie=='COL') echo ucfirst($designation); else echo 'Cols'; ?></span>
                            <ul class="filtre-menu-deroulant dinpro-regular">
                        ...
                        <li id="filtre_styles_select">
                           <span id="filtre_styles_selected"><?php if($categorie=='STYLE') echo ucfirst($designation); else echo 'Style'; ?></span>
                            <ul class="filtre-menu-deroulant dinpro-regular">
                        ...
                        <li id="filtre_tissages_select">
                           <span id="filtre_tissages_selected"><?php if($categorie=='TISSAGE') echo ucfirst($designation); else echo 'Tissage'; ?></span>
                            <ul class="filtre-menu-deroulant dinpro-regular">
                        ...
                        <li id="filtre_motifs_select">
                           <span id="filtre_motifs_selected"><?php if($categorie=='MOTIF') echo ucfirst($designation); else echo 'Motifs'; ?></span>
                            <ul class="filtre-menu-deroulant dinpro-regular">
                        ...
                        <li id="filtre_prix_select">
							...
							{
								if($_REQUEST["prix_debut"]=="59") $prix = "Prix de 59 € à 69 €";
								if($_REQUEST["prix_debut"]=="74") $prix = "Prix de 74 € à 79 €";
								if($_REQUEST["prix_debut"]=="89") $prix = "Prix de 89 € à 99 €";
								if($_REQUEST["prix_debut"]=="109") $prix = "Prix à 109 €";
							}
							?>
    ...
    <div class="container catalogue">
        <div class="row">
			...
			<?php
				...
				if($alias!='')
				{
					$condition_cat = ' where categorie="'.$designation.'"';
				}
				$sql = 'select * from tailorgeorge_modele '.$condition_cat.' order by id_auto desc';
				$query = $bdd->query($sql);
