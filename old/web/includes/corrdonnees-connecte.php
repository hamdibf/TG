...
<div class="row">
    <div class="col-xs-12">
        <!--  COORDONNEE  -->
        <p class="first" style="width: 100%; text-align: center">V&eacute;rifier votre adresse de livraison</p>
        <form id="formEditCoordonnees" name="formEditCoordonnees" action="verification-adresse.html" method="post">
            <!-- NOM / PRENOM / NUM -->
