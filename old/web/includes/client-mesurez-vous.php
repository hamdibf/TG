                ...
                <div class="row">
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-cou"></div>
                             <div class="input-group no-margin-bottom">
                                ...
                                <input class="input" type="text" name="cou_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['cou']; ?>">
                            </div>
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-poitrine"></div>
                             <div class="input-group no-margin-bottom">
                                ...
                                <input class="input" type="text" name="poitrine_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['poitrine']; ?>">
                            </div>
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-ceinture"></div>
                             <div class="input-group no-margin-bottom">
                                ...
                                <input class="input" type="text" name="ceinture_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['ceinture']; ?>">
                            </div>
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-carrure"></div>
                             <div class="input-group no-margin-bottom">
                                ...
                                <input class="input" type="text" name="carrure_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['carrure']; ?>">
                            </div>
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-dos"></div>
                             <div class="input-group">
                                ...
                                <input class="input" type="text" name="dos_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['dos']; ?>">
                            </div>
                        ...
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="methode-mesure-img big mesurez-vous-poignet"></div>
                             <div class="input-group no-margin-bottom">
                                ...
                                <input class="input" type="text" name="poignet_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['poignet']; ?>">
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="input-group">
                                ...
                                <input class="input" type="text" name="bras-gauche_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['brasgauche']; ?>">
                            </div>
                            <div class="input-group no-margin-bottom">
                                <label class="label" for="bras-droit">Droit (cm)</label>
                                <input class="input" type="text" name="bras-droit_vous" onfocus="activLabel(this)" onblur="activLabel(this)" required value="<?php echo $mesures['brasdroit']; ?>">
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="methode-mesure-rapide">
                            ...
                            <div class="input-group">
                                <select class="select-mesure" name="coupe_vous" id="coupe_vous" required value="<?php echo $mesures['aisance1']; ?>">
                                    <option value="droit">Droite</option>
                                    <option value="cintre">Cintrée</option>
                                </select>
                            </div>
                            <div class="input-group no-margin-bottom">
                                <select class="select-mesure" name="aisance_vous" id="aisance_vous" required value="<?php echo $mesures['aisance2']; ?>">
