                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <div class="input-group no-margin-bottom">
                                        ...
                                        <input class="input" type="number" name="number" onfocus="activLabel(this)" onblur="activLabel(this)"> 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="input" type="text" name="adresse" onfocus="activLabel(this)" onblur="activLabel(this)">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4">
                                    <!-- ADRESSE SUITE -->
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="input" type="text" name="renseignement" onfocus="activLabel(this)" onblur="activLabel(this)">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4">
                                    <!-- CODE POSTAL -->
                                    <div class="input-group">
                                        ...
                                        <input class="input" type="text" name="code-postal" onfocus="activLabel(this)" onblur="activLabel(this)">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4">
                                    <!-- VILLE -->
                                    <div class="input-group">
                                        ...
                                        <input class="input" type="text" name="ville" onfocus="activLabel(this)" onblur="activLabel(this)">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4">
                                    <!-- PAYS -->
