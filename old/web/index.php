...
<html>
    <head>
        ...
        <title>Chemise sur mesure en ligne – TailorGeorge</title>
        <meta name="description" content="Plus de 3000 modèles de chemises sur mesure à commander en ligne selon vos envies – Livraison 5 jours dans toute l'Europe" />
    ...
    <body>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="header-home">
                        <h1 class="oswald-regular">Nous fabriquons vos chemises sur mesure</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <!--<h2 class="h2-home dinpro-medium">Plus de 3000 modèles de chemises sur mesure à commander en ligne selon vos envies – Livraison 5 jours dans toute l'Europe</h2>-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="fin-apercu-catalogue">
                        <a href="avis-tailorgeorge.html" class="btn-rose">Voir tous les avis</a>
                    </div>
                </div>
            </div>
        </div>
